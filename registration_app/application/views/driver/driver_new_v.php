          ...
          <div class="card mx-auto mb-3">
            ...
            <div class="card-body">
              ...
              <!-- Body Section goes here -->
                ...
                <form  name="myForm" class="login-form" method="POST" action="<?php echo site_url('register/register_c/register_create'); ?>" enctype="multipart/form-data">
                  ...
                  <div class="form-group border" id="vehicle_info">
                      <div class="card-header">
                      <i class="fa fa-user"></i> Vehicle Information</div>
                      <div class="form-row">
                        <div class="col-md-3 form-control-sm">
                  ...
                  <div class="form-group border" id="attachment_info">
                    <div class="card-header">
                    <i class="fa fa-user"></i> Attachment Document</div>
                    <div class="form-row">
                      <div class="col-sm-3 form-control-sm">   
                  ...
                  <div class="form-group">
                        <input class="btn btn-primary btn-block" type="submit" value="Submit to System">
                  </div>
