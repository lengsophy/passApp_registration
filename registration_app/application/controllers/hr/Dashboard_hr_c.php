<?php
    ...
    class Dashboard_hr_c extends CI_Controller
    {
        public function __construct()
        {
            ...
            if ($this->session->userdata('group_name') !== 'HR') {
        ...
        public function index()
        {
            ...
            $data['my_reject']=$this->register_m->count_register_by_cri($cri);
            $cri = array(
                'department_id' => $this->common_m->get_department_by_staffid($this->session->userdata['emp_num']),
                'status_id' => 5
            );
            $data['my_done']=$this->register_m->count_register_by_cri($cri);
