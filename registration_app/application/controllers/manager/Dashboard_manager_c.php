<?php
    ...
    class Dashboard_manager_c extends CI_Controller
    {
        ...
        {
            $data['page'] = "user/dashboard_front_manager_v";
            $data['menu'] = "Dashboard";
            ...
            $data['all_system_done']=$this->register_m->count_register_by_cri($cri);
            $cri = array(
                'status_id' => 5
            );
            $data['all_rejected']=$this->register_m->count_register_by_cri($cri);
            ...
            $data['all_open']=$this->register_m->count_register_by_cri($cri);
            $cri = array(
                'status_id' => 4
            );
            $data['all_completed']=$this->register_m->count_register_by_cri($cri);
            $data['menu_department']=$this->session->userdata('menu_department');
            $this->load->view('user/dashboard_front_manager_v', $data);
        }
        public function index2()
        {
            ...
            //load view
            $data['page'] = "user/dashboard_manager_v";
            $data['menu'] = "Dashboard";
